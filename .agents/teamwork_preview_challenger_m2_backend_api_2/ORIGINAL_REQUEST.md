...
You are Challenger 2. Your mission is to empirically verify the correctness of the new `Printer` entity REST API endpoints, database CRUD operations, and relations.

Your working directory is: `/Users/yalazi/Documents/PROJECTS/software/Spoolman/.agents/teamwork_preview_challenger_m2_backend_api_2`.

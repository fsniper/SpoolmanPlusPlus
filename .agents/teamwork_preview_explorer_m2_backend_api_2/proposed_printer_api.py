...
class PrinterUpdateParameters(BaseModel):
    name: str | None = Field(None, min_length=1, max_length=256, description="Printer name.")
    model: str | None = Field(None, max_length=256, description="Optional printer model.")
    location: str | None = Field(None, max_length=256, description="Optional printer location.")
    comment: str | None = Field(None, max_length=1024, description="Optional comment.")
...
async def find(
    ...
    model: Annotated[
        ...
        Query(
            title="Printer Model",
            description="Filter by printer model.",
        ),
    ] = None,
    location: Annotated[
        str | None,
        Query(
            ...
            description="Filter by printer location.",
        ),
    ] = None,
    sort: Annotated[
        str | None,

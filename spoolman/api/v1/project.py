...
@router.get(
    ...
    name="Find project",
    description=(
        "Get a list of projects that matches the search query. "
        "A websocket is served on the same path to listen for updates to any project, or added or deleted projects. "
...
async def find(
    ...
    name: Annotated[
        ...
        Query(
            title="Project Name",
            description=(
                "Partial case-insensitive search term for the project name. Separate multiple terms with a comma. "
...
@router.get(
    ...
    name="Get project",
    description=(
        "Get a specific project. A websocket is served on the same path to listen for changes to the project. "
        "See the HTTP Response code 299 for the content of the websocket messages."
    ),
    response_model_exclude_none=True,
